-- ============================================
-- UPDATE VIEWS TO USE CORRECT GROUP COLUMNS
-- ============================================
...
-- Update group_summary_view to use group_name
...
-- Update meeting_summary_view to use group_name
...
DO $$
BEGIN
    RAISE NOTICE '✅ Views updated to use group_name column';
    RAISE NOTICE '📊 member_net_position_view: Now shows actual group names';
    RAISE NOTICE '📊 group_summary_view: Now shows actual group names';
    RAISE NOTICE '📊 meeting_summary_view: Now shows actual group names';
END $$;
